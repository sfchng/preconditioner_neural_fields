...
def plot_save_poses(opt,fig,pose,pose_ref=None,path=None,ep=None):
    ...
    plt.title("epoch {}".format(ep), fontsize=25)
    ...
    ax1.set_title("forward-facing view",pad=0, fontsize=20)
    ax2.set_title("top-down view",pad=0, fontsize=20)
    ...
    plt.savefig(png_fname,dpi=75, bbox_inches='tight', pad_inches=0)
    # clean up
    plt.clf()
...
def plot_save_poses_blender(opt,fig,pose,pose_ref=None,path=None,ep=None):
    ...
    ax.set_title("epoch {}".format(ep),pad=0,fontsize=20)
