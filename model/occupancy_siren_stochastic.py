...
class NeuralBinaryOccupancy(torch.nn.Module):
    ...
    def define_network(self,opt):
        ...
        self.mlp.append(SineLayer(input_features, opt.arch.siren.hidden_features, is_first=True, omega=opt.arch.siren.first_omega))
        for i in range(opt.arch.siren.hidden_layers):
            self.mlp.append(SineLayer(opt.arch.siren.hidden_features, opt.arch.siren.hidden_features, is_first=False, omega=opt.arch.siren.hidden_omega))
