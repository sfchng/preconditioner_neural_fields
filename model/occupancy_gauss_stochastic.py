...
class NeuralBinaryOccupancy(torch.nn.Module):
    ...
    def define_network(self,opt):
        ...
        self.mlp.append(GaussianLayer(input_features, opt.arch.gaussian.hidden_features, sigma=opt.arch.gaussian.sigma))
        for i in range(opt.arch.gaussian.hidden_layers):
            self.mlp.append(GaussianLayer(opt.arch.gaussian.hidden_features, opt.arch.gaussian.hidden_features, sigma=opt.arch.gaussian.sigma))
